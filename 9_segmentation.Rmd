...
**Hint 1** : You might want to constrain the search for the right eye to a particular part of the image, and then refine within this area.

**Hint 2** : Remember, you want a *mask* defining the right eye (not the boundary).
